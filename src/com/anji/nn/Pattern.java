...
public class Pattern {
	...
	/**
	 * <code>protected</code> visibility increases performance of <code>PatternConnection.read()</code>
	 */
	...
	/**
	 * Create Pattern with <code>dimension</code> inputs. This ctor should be called if <code>Pattern</code> object is
	 * to manage array of values.
	 * 
	 * @param dimension
	...
	/**
	 * Create Pattern with <code>aValues</code> as inputs. This ctor should be called if caller is to manager array of
	 * values;
	 * 
	 * @param aValues
	 * @throws IllegalArgumentException
