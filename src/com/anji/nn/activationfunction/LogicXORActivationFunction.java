...
public class LogicXORActivationFunction extends LogicActivationFunction {
	...
	/**
	 * Returns the result of a logical XOR over all inputs, where an input value greater than or equal to 0.5 is considered logical true, and less than 0.5 false.
