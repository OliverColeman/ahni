...
public class XmlPersistableAllele implements XmlPersistable {
	...
	public String toXml() {
		...
		if (allele instanceof NeuronAllele) {
			...
			result.append(NEURON_XML_TYPE_TAG).append("=\"").append(nAllele.getType().toString()).append("\" ");
			result.append(NEURON_XML_ACTIVATION_TYPE_TAG).append("=\"").append(nAllele.getActivationType());
			result.append("\"/>\n");
