	...
	public void evaluate(List genotypes) {
		...
		while (it.hasNext()) {
			...
			try {
				...
				genotype.setFitnessValue(calculateErrorFitness(responses, activator.getMinResponse(), activator.getMaxResponse()) - (int) (adjustForNetworkSizeFactor * genotype.size()));
