...
public class Gene implements Comparable, Serializable {
	...
	/**
	 * Innovation ID is analagous to the locus of a real gene. Genes with the same innovation ID in 2 chromosomes are
	 * considered to be 2 alleles of the same gene.
	 * 
	 * @return unique identifier; see <a href="http://nn.cs.utexas.edu/downloads/papers/stanley.ec02.pdf">NEAT </a>
