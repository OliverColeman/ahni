...
public abstract class AHNIFitnessFunction implements BulkFitnessFunction {
	 ...
	 * @param totallLayerCount The total number of layers in the substrate network. This can be used to determine, for
	 ...
	 *         {@link HyperNEATTranscriber.RANGE_X} and the corresponding Ranges for the x and y axes will be used to
