 ...
 * methods {@link #init(Properties)}, {@link #initialiseEvaluation()}, {@link #postEvaluate(Chromosome, Activator, int)}, {@link #scale(int, int)} and {@link #dispose()}. See
...
public abstract class HyperNEATFitnessFunction extends BulkFitnessFunctionMT {
	...
	/**
	 * Sub-classes may override this method to perform operations after a Chromosome has been evaluated. This method should be called from the overriding method.
