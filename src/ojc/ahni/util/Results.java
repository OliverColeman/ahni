...
public class Results {
	...
	/**
	 * @return True iff the data series have labels.
	 */
	...
	/**
	 * @return The label for the given series, if available (null if no labels are available).
	 */
	public String getLabel(int series) {
		return labels != null ? labels[series] : null;
	}
	...
	public void add(Results results) {
		...
		if (hasLabels() && results.hasLabels()) {
